...
private:
	...
	GLFWwindow * glfw_window; // Pointer to glfw_window
...
public:
	...
	void initGLFWSurface(GLFWwindow * glfw_window) {

		if (VK_SUCCESS != glfwCreateWindowSurface(instance, glfw_window, nullptr, &surface)) {
			glfwTerminate();
	...
	*/
	void create(uint32_t *width, uint32_t *height, bool vsync = false)
	{
		...
		int gwidth, gheight;
		glfwGetWindowSize(glfw_window, &gwidth, &gheight);
