#ifndef VULKANTEXTOVERLAY_HPP
#define VULKANTEXTOVERLAY_HPP
...
public:
	...
	*/
	void preparePipeline()
	{
		...
		std::vector<VkVertexInputBindingDescription> vertexBindings(2);
		...
		std::vector<VkVertexInputAttributeDescription> vertexAttribs(2);
		// Position
